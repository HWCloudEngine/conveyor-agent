...
global_opts = [
    ...
    cfg.ListOpt('osapi_v2v_ext_list',
                default=[],
    ...
    cfg.StrOpt('rootwrap_config',
               default='/etc/conveyoragent/rootwrap.conf',
    ...
    cfg.StrOpt('volume_api_class',
               default='conveyoragent.volume.cinder.API',
               help='The full class name of the volume API class to use'),
    cfg.StrOpt('backup_api_class',
               default='conveyoragent.backup.api.API',
