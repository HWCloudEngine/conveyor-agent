...
class ExtensionManager(object):
    ...
    See conveyoragent/tests/api/extensions/foxinsocks/extension.py for an
    ...
    def __init__(self):
        ...
        self.cls_list = CONF.osapi_v2v_extension
        self.extensions = {}
...
class ControllerExtension(object):
    """Extend core controllers of conveyoragent OpenStack API.

    Provide a way to extend existing conveyoragent OpenStack API core
    controllers.
    """
...
class ResourceExtension(object):
    """Add top level resources to the OpenStack API in conveyoragent."""
