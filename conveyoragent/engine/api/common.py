...
def remove_version_from_href(href):
    ...
    Given: 'http://www.conveyoragent.com/v1.1/123'
    Returns: 'http://www.conveyoragent.com/123'

    Given: 'http://www.conveyoragent.com/v1.1'
    Returns: 'http://www.conveyoragent.com'
