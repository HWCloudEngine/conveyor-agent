...
def find_config(config_path):
    ...
    :raises: `conveyoragent.exception.ConfigNotFound`

    """
    possible_locations = [
        config_path,
        os.path.join(CONF.state_path, "etc", "conveyoragent", config_path),
        os.path.join(CONF.state_path, "etc", config_path),
        os.path.join(CONF.state_path, config_path),
        "/etc/conveyoragent/%s" % config_path,
    ]
...
def monkey_patch():
    ...
    Example: 'conveyoragent.api.ec2.cloud:' \
     conveyoragent.openstack.common.notifier.api.notify_decorator'

    Parameters of the decorator is as follows.
    (See conveyoragent.openstack.common.notifier.api.notify_decorator)
